...
We can't recover the parameters values we used when simulating the data. Dummy coding is equivalent to specifying each included level as a contrast with the reference level. We can compare the dummy-coded marginal posteriors to the contrasted true parameter values.
...
![](Figures/flat-contrasts-dummy.png){width=750px}
...
Also known as sum-to-zero coding, effects coding generalizes the idea of dummy coding to more flexibly identify any contrast among the levels of a discrete variable.
