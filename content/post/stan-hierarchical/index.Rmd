...
Once the model has finished running, we can check diagnostics (here using a helper function `stan_utility`, though the diagnostic checks can all be done separately), including checking for divergences, a powerful indicator of problems with the sampler that is unique to Hamiltonian Monte Carlo.
...
The model looks good. There are a few more things we should consider:
