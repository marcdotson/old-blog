...
To address this issue, we need to reparameterize our hierarchical model such that the posterior geometry is easier to navigate. The non-centered parameterization is commonly used, imposing a deterministic transformation between layers in the hierarchy.
...
- Increasing `adapt_delta` (the tuning parameter, default is `0.8`).
- Improving numerical accuracy of the calculations (e.g., to more than 8 decimal places).
