...
```{stan generate-data-00, output.var="generate_data_00", eval=FALSE}
...
Note that even though we've preemptively set `adapt_delta = 0.99` given the previous model's performance, it will be easy to run into problems with the additional dimensions we've added to the posterior. We'll touch on a common solution, when needed, at the end. For now the model has finished calibration without any warnings.
