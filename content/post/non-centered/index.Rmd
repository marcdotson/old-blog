...
- "change the prior on Beta to a multivariate normal" -- why?
- Start with variance heterogeneity and reference it in the previous post?
...
- Position this as a part 2 or just a follow-up where we deal with variance heterogeneity and non-centered parameterizations?
